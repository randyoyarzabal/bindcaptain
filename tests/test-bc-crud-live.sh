...
# Requirements:
#   - BC_LIVE_TESTS=1
#   - BC_HOST set (e.g. root@dns.example.com) when running from your workstation
...
#
# Usage:
#   BC_LIVE_TESTS=1 BC_HOST=root@dns.example.com ./tests/test-bc-crud-live.sh
#
...
TAG="bct$(date +%s)-$$"
# Same /24 as the docs-reserved range; PTR reverse zones usually include 192.0.2.0/24.
IP_A="192.0.2.240"
IP_ML="192.0.2.242"
IP_UP1="192.0.2.243"
IP_UP2="192.0.2.244"
