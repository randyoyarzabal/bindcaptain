...
PTR records are created **automatically** when you add A records with `bc.create_record`, for networks configured in the manager (e.g. 10.0.1.0/24, 10.0.2.0/24, 10.0.3.0/24). No separate PTR command is needed.
